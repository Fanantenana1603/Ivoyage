...
class VoyagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voyage" do
    assert_difference('Voyage.count') do
      post voyages_url, params: { voyage: { date_depart: @voyage.date_depart, depart: @voyage.depart, destination: @voyage.destination } }
    end
  ...
  test "should update voyage" do
    patch voyage_url(@voyage), params: { voyage: { date_depart: @voyage.date_depart, depart: @voyage.depart, destination: @voyage.destination } }
